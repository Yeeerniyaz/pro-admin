...
import { Users, Shield, Phone, User as UserIcon, X, CheckCircle } from 'lucide-react-native';
    ...
    return (
      <PeCard style={styles.userCard}>
        <View style={GLOBAL_STYLES.rowBetween}>
          ...
          {/* Кастомный бейдж роли (вместо стандартного PeBadge) */}
  ...
  return (
    <View style={GLOBAL_STYLES.safeArea}>
      ...
      <View style={styles.header}>
        <View style={GLOBAL_STYLES.rowCenter}>
          <Users color={COLORS.primary} size={28} style={{ marginRight: SIZES.small }} />
          <View>
            <Text style={GLOBAL_STYLES.h1}>Персонал</Text>
            <Text style={GLOBAL_STYLES.textMuted}>База клиентов и доступы (v10.0)</Text>
          </View>
        </View>
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={[GLOBAL_STYLES.textMuted, { marginTop: SIZES.medium }]}>База пользователей пуста</Text>
            </View>
          }
        />
      )}
          ...
          <View style={styles.modalContent}>
            ...
            {ROLE_OPTIONS.map((roleOpt) => {
              ...
              return (
                ...
                >
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.roleOptionTitle, isActive && { color: COLORS.primary }]}>
                      {roleOpt.label}
                    </Text>
            ...
            {roleUpdating && (
              <ActivityIndicator size="small" color={COLORS.primary} style={{ marginTop: SIZES.large }} />
            )}
